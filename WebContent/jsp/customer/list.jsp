										...
										<TABLE id=grid
											...
											<TBODY>
											   ...
											   <%--  <s:iterator  value="list" var="cus">
													...
													<TD><s:property value="#cus.dictCustLevel.dname"/></TD>
													...
													<TD>
													   ...
													   <a href="${pageContext.request.contextPath}/customer_showCustomer.action?cid=<s:property value="#cus.cid"/>">修改</a>
													</TD>
												</TR>
									...
									<TD><SPAN id=pagelink>
											<DIV
												...
												<c:if test="${pageBean.currentPage!=1 }">
						                          [<A href="${pageContext.request.contextPath }/customer_list.action?currentPage=${pageBean.currentPage-1}">前一页</A>] 
												</c:if>
											    <c:if test="${pageBean.currentPage!=pageBean.totalPage }">
											      [<A href="${pageContext.request.contextPath }/customer_list.action?currentPage=${pageBean.currentPage+1}">后一页</A>] 
