										...
										<TABLE id=grid
											...
											<TBODY>
											   ...
											   <%--  <s:iterator  value="list" var="cust">
													...
													<TD>
													   <a href="${pageContext.request.contextPath}/customer_delete.action?cid=<s:property value="#cust.cid"/>">删除</a>
													</TD>
													<TD>
													   <a href="${pageContext.request.contextPath}/customer_showCustomer.action?cid=<s:property value="#cust.cid"/>">修改</a>
													</TD>
												</TR>
